        ...
        <div className='w-[100%] lg:w-[1000px] mx-auto'>
            <div className='mainDiv bg-[#e88069] relative h-[640px] w-full rounded-2xl px-20 flex items-center overflow-hidden'>
                <div className="textDiv w-[55%]">
                    ...
                    <div className='mt-12'>
                    <Link to={'/aboutCompany'} className='uppercase font-medium px-8 py-4 rounded-xl bg-white text-[#1c1b1d] hover:bg-[#ffac99] hover:text-white transition duration-500 ease-in-out'>
                        Learn More
                    </Link>
                    </div>
                </div>
