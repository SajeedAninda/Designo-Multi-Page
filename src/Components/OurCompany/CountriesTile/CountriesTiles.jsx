      ...
      <div className='w-[1000px] mx-auto'>
        <div className='grid grid-cols-3 gap-12 items-center'>
          <div className='passionate flex flex-col items-center relative'>
            ...
            <Link to={"/locations"} className='uppercase font-medium mt-8 px-8 py-4 rounded-xl bg-[#E88069] text-white hover:bg-[#ffac99ab] hover:text-white transition duration-500 ease-in-out'>
              See Location
            </Link>
          </div>
